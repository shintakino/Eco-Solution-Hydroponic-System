...
class SensorDataHandler {
    ...
    function storeDHT11Data($temperature, $humidity, $vpd) {
        $query = "INSERT INTO sensordata (temperature, humidity, vpd) VALUES ('$temperature', '$humidity', '$vpd')";
...
if(isset($_GET['temperature'], $_GET['humidity'], $_GET['vpd'], $_GET['light'], $_GET['EC'], $_GET['ph_value'])) {
    ...
    $sensorDataHandler->storeDHT11Data($temperature, $humidity, $vpd);
